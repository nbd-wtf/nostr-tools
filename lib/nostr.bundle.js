...
var NostrTools = (() => {
  ...
  var SendNdebitRequest = async (pool, privateKey, relays, pubKey, data) => {
    ...
    const content = encrypt3(JSON.stringify(data), getConversationKey(privateKey, pubKey));
    ...
    decrypt3(res.content, getConversationKey(privateKey, pubKey));
